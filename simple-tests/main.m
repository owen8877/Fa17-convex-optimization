...
%     {@ctransimplexWrapper, 'tran_simplex_normal', struct('method', 'normal')}; ...
%     {@ctransimplexWrapper, 'tran_simplex_improved', struct('method', 'improved')}; ...
%     {@ctransimplexWrapper, 'tran_simplex_shortlist', struct('method', 'shortlist')}; ...
    {@admm_dual, 'admm_dual', struct('tor', 1e-5)}; ...
};
caseN = size(query, 1);
