...
%     {@transimplexWrapper, 'shortlist', struct('method', 'shortlist')}; ...
    {@transimplexWrapper, 'multiscale', struct('method', 'multiscale', 'extra', false)}; ...
    {@transimplexWrapper, 'multiscale_s', struct('method', 'multiscale', 'extra', true)}; ...
};
caseN = size(query, 1);
